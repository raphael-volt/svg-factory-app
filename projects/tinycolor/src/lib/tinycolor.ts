...
const tinycolor = (color: any, opts?: any) => {
    color = (color) ? color : '';
    opts = opts || {};
...
const rgbToHex = (r, g, b, allow3Char) => {
...
const rgbaToHex = (r, g, b, a, allow4Char) => {
...
const analogous = (color, results, slices) => {
    results = results || 6;
    slices = slices || 30;
...
const monochromatic = (color, results) => {
    results = results || 6;
...
var hexNames: any// = tinycolor.hexNames = flip(names);
...
const stringInputToObject = (color) => {
    ...
    // Keep most of the number bounding out of this const - don't worry about [0,1] or [0,100] or [0,360]
...
const validateWCAG2Parms = (parms) => {
