...
import { RGB } from './helpers/color.interfaces';

@Component({
  selector: 'color-previews',
  template: `
  <div>
    <div class="photoshop-label">nouvelle</div>
    ...
    <div class="photoshop-label">actuelle</div>
  </div>
  `,
  styles: [
    `
...
export class PreviewsComponent implements OnChanges {
  @Input() rgb: RGB;
  @Input() currentColor = '';
  backgroundNew = '';
